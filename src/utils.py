...
class Model(nn.Module):
    def __init__(self, number_of_class=8, dropout=0.5, k_c=3):
        ...
        self._pool1 = nn.MaxPool3d(kernel_size=(3, 1, 1))

        self._conv2 = nn.Conv3d(32, 64, kernel_size=(k_c, 1, 2), bias=False)
        ...
        self._conv3 = nn.Conv3d(64, 128, kernel_size=(k_c, 1, 2), bias=False)
        self._batch_norm3 = nn.BatchNorm3d(128)
        self._prelu3 = nn.PReLU(128)
        self._dropout3 = nn.Dropout3d(dropout)
        self._pool3 = nn.MaxPool3d(kernel_size=(3, 1, 1))

        self._fc1 = nn.Linear(4992, 1024)
